...
const Dashboard = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "white"  , position:'relative' }}>
      ...
      <TouchableOpacity className='absolute bottom-5 right-5 h-16 rounded-full w-16 bg-[#029BF7] z-10 flex justify-center items-center' >
          ...
          <View className=" gap-y-1 border-[1px] rounded-2xl px-3 py-2 flex flex-col justify-evenly">
            <View className="flex flex-row justify-between items-center">
              ...
              <View className="flex flex-row justify-end items-center gap-2">
                ...
                <Text className="font-PopLight text-sm">High</Text>
                <TouchableOpacity>
            ...
            <View className="flex flex-row justify-between items-center">
              <View className="w-4/12 gap-1">
                <Text className="text-sm font-PopLight">Current Status</Text>
