  ...
  return (
    <PaperProvider>
      <SafeAreaView className="p-4" style={{ marginTop: -15 }}>
        <Text
          className="text-md font-popMedium pb-1 mt-3"
        ...
        {familyData.map((data) => {
          return (
            <View>
              {peoplechange === "people"
                ? data.peoplefirstname !== null &&
                  data.peoplefirstname !== "" && (
                    <View
                      className="border h-[25vh] mb-3 rounded p-3"
                    ...
                    >
                      ...
                      <View className="mr-7">
                        ...
                        <Text
                          ...
                          style={{ color: "#54585A" }}
                        >
                          View, Mobile Notifications ({data.peoplepermissions}{" "}
                          Once)
                        </Text>
                      </View>
                    </View>
        ...
        {reviewerData.map((data) => {
          return (
            <View>
              {peoplechange !== "people"
                ? data.reviewerfirstname !== null &&
                  data.reviewerfirstname !== "" && (
                    <View
                      className="border h-[20vh] mb-3 rounded p-3"
                      style={{ borderColor: "#D0D2D2" }}
                    >
                      <View className="flex flex-row">
                        <View>
              ...
              <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                  <ScrollView>
                    <View className="flex flex-row">
                      <Text
                        className="text-md font-popMedium mr-48"
                        style={{
                          color: "#263238",
                          fontSize: 18,
                          alignItems: "center",
                    ...
                    <View>
                      ...
                      <View
                        className="border rounded text-2xl font-popMedium mb-2"
                        style={{ borderColor: "#D0D2D2" }}
                      >
                        <Picker
                          style={{ color: "#54585A" }}
              ...
              <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                  <ScrollView>
                    <View className="flex flex-row">
                      <Text
                        className="text-md font-popMedium mr-44"
                        style={{
                          color: "#263238",
                          fontSize: 18,
                          alignItems: "center",
