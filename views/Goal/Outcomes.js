    ...
    <View className="pb-2 mt-3">
      ...
      <View className="mb-4">
        ...
        {data.map((data,index)=>{
          ...
          <TouchableOpacity>
            <Ionicons name="trash-outline" style={{position:'absolute', bottom:30, left:310}} size={25} color={'red'}/>
          </TouchableOpacity>
          <View className="flex flex-row">
            <View className="mr-7">
          ...
          <Modal
            ...
            <View style={styles.modalContent}>
              ...
              <View className='flex flex-row' style={{alignItems:"center", marginBottom:15}}>
                ...
                <Ionicons size={30} name="close-outline" style={{color:'#444444'}} onPress={() => setModalVisible(false)} />
              </View>
              <View>
                ...
                placeholderTextColor={'#54585A'} onChangeText={milestonename1} inputValue={milestonename} placeholder='Enter Name' />
                ...
                placeholderTextColor={'#54585A'} onChangeText={milestonedesc1} inputValue={milestonedesc} placeholder='Enter Description'/>
